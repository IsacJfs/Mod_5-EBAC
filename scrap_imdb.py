...
def extract_movie_details(movie_link):
    ...
    if movie_soup is not None:
        ...
        plot_text = movie_soup.find('span', attrs={'class': 'sc-466bb6c-0 hlbAws'}).get_text().strip() if movie_soup.find(
            'span', attrs={'class': 'sc-466bb6c-0 hlbAws'}) else None

        with open('movies.csv', mode='a', encoding='utf8') as file:
